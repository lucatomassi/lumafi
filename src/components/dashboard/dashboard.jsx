...
class Dashboard extends Component {
  ...
  constructor(props) {
    ...
    const growth = localStorage.getItem('luma.fi-dashboard-growth')
    const currency = localStorage.getItem('luma.fi-dashboard-currency')
  ...
  growthClicked = () => {
    ...
    localStorage.setItem('luma.fi-dashboard-growth', newGrowth.toString())
  }
  ...
  balanceClicked = () => {
    ...
    localStorage.setItem('luma.fi-dashboard-currency', (currency === 'USD' ? 'ETH' : 'USD'))
  }
