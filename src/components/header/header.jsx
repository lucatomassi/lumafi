      ...
      <div className={ classes.root }>
        <div className={ classes.headerV2 }>
          <div className={ classes.icon }>
            <img
              alt=""
              src={ require('../../assets/moon128.png') }
              height={ '40px' }
              onClick={ () => { this.nav('') } }
            />
            <Typography variant={ 'h3'} className={ classes.name } onClick={ () => { this.nav('') } }>Luma-Fi</Typography>
          </div>
          <div className={ classes.links }>
            { this.renderLink('Dashboard') }
            { this.renderMenuLinks({ label: 'Yield', screens: ['vaults', 'earn'] }) }
