...
class Vault extends Component {
  ...
  constructor(props) {
    ...
    const basedOn = localStorage.getItem('luma.fi-dashboard-basedon')
    ...
    this.state = {
      ...
      search: '',
      searchError: false,
      hideZero: localStorage.getItem('luma.fi-hideZero') === '1' ? true : false,
  ...
  handleChecked = (event) => {
    ...
    localStorage.setItem('luma.fi-hideZero', (event.target.checked ? '1' : '0' ))
  }
    ...
    return(
          <div className={ classes.disaclaimer } style={{ marginTop: '25px', maxWidth: '500px' }}>
            ...
            <Typography variant="body1">
              <b>The Vaults are not implemented yet, this feature will allow our own smart-contracts to manage pooled funds, in order to determine the best underlying strategies to generate optimal yield.</b> 
            </Typography>
          </div>
    )
  }
  ...
  onSelectChange = (event) => {
    ...
    localStorage.setItem('luma.fi-dashboard-basedon', event.target.value)
